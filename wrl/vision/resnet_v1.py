...
from wrl.vision.film_conditioning_layer import FilmConditioning
from wrl.vision.data_augmentations import resize
ModuleDef = Any
...
class ResNetEncoder(nn.Module):
    ...
    def __call__(
        ...
        # `encode` is accepted for interface compatibility with
        # PreTrainedResNetEncoder (where it lets callers pre-encode and skip
        # the conv stack). ResNetEncoder always runs the full stack.
        del encode
