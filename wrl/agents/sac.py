...
from typing import ClassVar, FrozenSet, Iterable, Optional, Tuple
...
from wrl.common.common import JaxRLTrainState, ModuleDict, nonpytree_field
from wrl.common.encoding import EncodingWrapper
from wrl.common.optimizers import make_optimizer
from wrl.common.typing import Batch, Data, Params, PRNGKey
...
from wrl.utils.train_utils import _unpack
...
class SACAgent(flax.struct.PyTreeNode):
    ...
    # Subnetwork groups the learner uses for staggered updates.
    ...
    def update(
        ...
        **kwargs
        ...
        image_keys = self.config.get("image_keys")
        if image_keys and image_keys[0] not in batch["next_observations"]:
            batch = _unpack(batch)
    ...
    def create_pixels(
        ...
        **kwargs,
        ...
        if encoder_type == "resnet":
            ...
            from wrl.vision.resnet_v1 import (
